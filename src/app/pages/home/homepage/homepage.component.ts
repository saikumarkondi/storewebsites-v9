        ...
        if (pssd) {
          ...
          if (this.returnUrl !== undefined && this.returnUrl !== '/' && this.returnUrl !== '/home') {
            if (this.returnUrl !== '/checkout') {
              ...
              if (this.returnUrl.startsWith('/beer') || this.returnUrl.startsWith('/wine') || this.returnUrl.startsWith('/liquor') || this.returnUrl.startsWith('/mixers-more') || this.returnUrl.startsWith('/advance-filter')) {
